...
(async () => {
  try {
    ...
    var env = "agent";
    var api_url = `https://${env}.api.next-linux.systems/v1`;
    var web_url = "https://app.next-linux.systems";
    ...
    const downloadPath: string = await tc.downloadTool(
      "https://github.com/nextlinux/agent/releases/download/v0.13.2/agent_0.13.2_linux_amd64.tar.gz",
      undefined,
      auth
    );
